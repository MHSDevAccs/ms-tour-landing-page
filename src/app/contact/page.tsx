...
export default async function ContactPage() {
  ...
  // Use only socialSettings for social media data and clean URLs
  const socialData = socialSettings ? {
    ...socialSettings,
    socialMedia: cleanSocialMediaUrls(socialSettings.socialMedia || {})
  } : null
        ...
        <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <StaggerItem>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
              <h2 className="text-lg sm:text-2xl font-semibold text-black mb-4 sm:mb-6">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {contactData.contactInfo.phone && (
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 text-gray-600 mt-1">
                    ...
                    <div className="ml-3 sm:ml-4">
                      ...
                      <a 
                        ...
                        className="text-sm sm:text-base text-black/70 hover:text-primary transition-colors"
                      >
                        {contactData.contactInfo.phone}
                      </a>
                    </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
                ...
                <div className="space-y-2 sm:space-y-3">
                  {contactData?.businessHours ? (
                    ...
                    <p className="text-sm sm:text-base text-gray-600">Tidak ada jam operasional tersedia saat ini.</p>
                  )}
                </div>
              </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    {socialData?.socialMedia?.instagram && (
                      ...
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center mr-3">
                        ...
                        <div>
                          <div className="font-medium text-sm sm:text-base text-gray-900 group-hover:text-pink-600 transition-colors duration-200">Instagram</div>
                          <div className="text-xs sm:text-sm text-gray-500">Follow kami di Instagram</div>
                        </div>
                      </a>
                    )}
                    ...
                    {socialData?.socialMedia?.facebook && (
                      ...
                      >
                        ...
                        <div>
                          <div className="font-medium text-sm sm:text-base text-gray-900 group-hover:text-blue-600 transition-colors duration-200">Facebook</div>
                          <div className="text-xs sm:text-sm text-gray-500">Halaman Facebook kami</div>
                        </div>
                      </a>
                    )}
                    ...
                    {socialData?.socialMedia?.youtube && (
                      ...
                      >
                        ...
                        <div>
                          <div className="font-medium text-sm sm:text-base text-gray-900 group-hover:text-red-600 transition-colors duration-200">YouTube</div>
                          <div className="text-xs sm:text-sm text-gray-500">Subscribe channel YouTube kami</div>
                        </div>
                      </a>
                    )}
                    ...
                    {socialData?.socialMedia?.twitter && (
                      ...
                      >
                        ...
                        <div>
                          <div className="font-medium text-sm sm:text-base text-gray-900 group-hover:text-sky-600 transition-colors duration-200">Twitter</div>
                          <div className="text-xs sm:text-sm text-gray-500">Follow kami di Twitter</div>
                        </div>
                      </a>
                    )}
                    ...
                    {socialData?.socialMedia?.tiktok && (
                      ...
                      >
                        ...
                        <div>
                          <div className="font-medium text-sm sm:text-base text-gray-900 group-hover:text-gray-700 transition-colors duration-200">TikTok</div>
                          <div className="text-xs sm:text-sm text-gray-500">Follow kami di TikTok</div>
                        </div>
                      </a>
                    )}
                  </div>
